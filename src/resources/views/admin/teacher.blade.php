  				...
  				<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
					...
					<tbody>
						...
						<tr>
							...
							<td>{{$teacher->email}}</td>
							<td width="140">
								<a data-placement="left" title="Click to Edit" href="{{route('editteacher',$teacher->id)}}"  data-toggle="modal" class="btn btn-success btnedit">Edit</a>
								<!-- <input type="submit" name="edit" value="Edit"> -->
								<a data-placement="left" title="Click to Delete" href="{{route('deleteteacher',$teacher->id)}}"  data-toggle="modal" class="btn btn-danger">Delete</a>
							</td>
						</tr>
					</tbody>
					@endforeach
