    		...
    		<form action="{{route('updateteacher')}}" method="post">
  				...
  				<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
  						...
  						<tr>
  							<td>Name</td>
  							<td>
  								<input type="text" name="teacher_name"  value="{{$teacher->name}}" style="width: 220px;height: 30px">	
  						...
  						<tr>
  							<td>Contact</td>
  							<td>
  								<input type="text" name="teacher_contact"  value="{{$teacher->contact}}" style="width: 220px;height: 30px">	
  							</td>
  						</tr>
  						<tr>
  							<td>Designation</td>
  							<td>
  								<input type="text" name="teacher_designation"  value="{{$teacher->designation}}" style="width: 220px;height: 30px">	
  							</td>
  						</tr>
						<tr>
